...
const _sfc_main = {
  ...
  setup() {
    useSeoMeta({
      ...
      description: "Experience the industry's first-ever contact-to-close platform and transform your business with the nation's #1 residential brokerage."
    });
  },
  data() {
    return {
...
//# sourceMappingURL=Partner-tTMvJC0w.mjs.map
