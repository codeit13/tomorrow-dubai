import { m as mapState, b as useSeoMeta, c as cn, _ as _export_sfc, d as __nuxt_component_0 } from '../server.mjs';
...
const _sfc_main = {
  ...
  head: {
    ...
    meta: [
      {
        name: "title",
        content: "Exclusive Dubai Luxury Real Estate - Tomorrow Luxury Property"
      },
      {
        name: "description",
        content: "Enhance your property journey with Tomorrow Luxury Property. Collaborate with our expert real estate agents to discover the perfect luxury home or apartment for you."
      }
    ]
  },
  data() {
...
//# sourceMappingURL=index-S7PdRfgJ.mjs.map
