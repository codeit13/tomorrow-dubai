import { u as useHead, m as mapState, _ as _export_sfc } from '../server.mjs';
  ...
  setup() {
    useHead({
      ...
      meta: [
        {
          name: "description",
          content: "At Tomorrow Luxury Property, you will receive comprehensive information on the latest off-plan projects and developments in Palm Jebel Ali, Palm Jumeirah, Dubai Island, and Downtown Dubai, UAE"
        }
      ]
    });
  },
...
//# sourceMappingURL=OffPlan-G4JdNhp9.mjs.map
