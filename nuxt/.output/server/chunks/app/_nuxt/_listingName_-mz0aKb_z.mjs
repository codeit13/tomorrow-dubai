...
import { a as useRoute, u as useSeoMeta, m as mapState, _ as _export_sfc, c as cn } from '../server.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  if ($data.title) {
    ...
    if ($data.isOffPlan) {
      _push(`<div class="flex flex-wrap justify-between items-start md:items-end sticky"><span class="text-sm md:text-xl font-extrabold josefin-slab mb-20 cursor-pointer uppercase">${ssrInterpolate(`< Off Plan`)}</span><div class="text-center"><h1 class="text-2xl md:text-4xl montserrat-font mb-3">${ssrInterpolate($data.title)}</h1><p class="text-sm md:text-xl mb-3 josefin-slab font-[600] uppercase">${ssrInterpolate($data.subtitle)}</p>`);
      if ($data.startingPrice) {
        _push(`<p class="text-sm md:text-xl"> STARTING FROM AED ${ssrInterpolate((_a = $data.startingPrice) == null ? void 0 : _a.toLocaleString("en-US"))}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><span></span></div>`);
    } else {
      _push(`<div class="flex flex-wrap justify-between items-start gap-10 md:items-end sticky"><div><h1 class="text-2xl md:text-3xl montserrat-font mb-4">${ssrInterpolate($data.title)}</h1><p class="text-sm md:text-lg mb-4 josefin-slab font-[600] uppercase">${ssrInterpolate($data.subtitle)}</p><p class="text-sm md:text-lg font-bold">${ssrInterpolate($data.featureText)}</p></div>`);
      if ($data.startingPrice) {
        _push(`<div class="md:text-right"><p class="text-3xl font-semibold"> AED ${ssrInterpolate((_b = $data.startingPrice) == null ? void 0 : _b.toLocaleString("en-US"))}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
    ...
    _push(ssrRenderComponent(_component_carousel, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`<!--[-->`);
          ssrRenderList($data.propertyImages, (url, i) => {
          ...
          return [
            (openBlock(true), createBlock(Fragment, null, renderList($data.propertyImages, (url, i) => {
    ...
    _push(`<div class="pt-6"><h2 class="text-xl md:text-2xl font-semibold mb-6"> Property Descriptions </h2><p class="text-sm md:text-lg text-justify">${$data.shortDescription}</p>`);
    if ($data.showMoreBtn) {
    ...
    if ($data.isOffPlan && $data.paymentPlans) {
      ...
      ssrRenderList($data.paymentPlans, (plan, i) => {
    ...
    if ($data.agent) {
      _push(`<div class="flex items-center md:items-start flex-wrap md:flex-nowrap justify-start gap-8 md:p-8"><div class="rounded-full bg-gray-200 mb-4"><img alt="Agent" class="w-[200px] h-full rounded-full"${ssrRenderAttr("src", $data.agent.img)} style="${ssrRenderStyle({
        aspectRatio: "1/1",
        objectFit: "cover"
      })}"></div><div class="w-full"><h3 class="text-lg montserrat-font mb-3">LISTING AGENT</h3><p class="font-semibold montserrat-font mb-3">${ssrInterpolate($data.agent.name)}</p><p class="mb-3"><a${ssrRenderAttr("href", `mailto:${$data.agent.email}`)} class="text-sm montserrat-font">${ssrInterpolate($data.agent.email)}</a></p><p class="mb-3"><a${ssrRenderAttr("href", `tel:${$data.agent.phone}`)} class="text-sm montserrat-font">${ssrInterpolate($data.agent.phone)}</a></p><div class="flex mt-6">`);
      _push(ssrRenderComponent(_component_Button, {
        class: "rounded-none border-2 transition-all border-[#000] bg-white text-sm font-semibold text-[#25D366] mt-2",
        variant: "outline",
        onClick: ($event) => $options.goToWhatsapp($data.agent.phone)
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` WhatsApp `);
      ...
      _push(ssrRenderComponent(_component_Button, {
        onClick: ($event) => $options.goToCall($data.agent.phone),
    ...
    if ($data.coordinates && $data.coordinates.length > 0) {
      ...
      if ($data.address) {
        _push(`<span class="text-lg">${ssrInterpolate($data.address)}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
                        ...
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_ol_feature, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(_component_ol_geom_point, { coordinates: $data.coordinates }, null, _parent5, _scopeId4));
                                _push5(ssrRenderComponent(_component_ol_style, null, {
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(ssrRenderComponent(_component_ol_style_circle, { radius: $data.radius }, {
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(ssrRenderComponent(_component_ol_style_fill, { color: $data.fillColor }, null, _parent7, _scopeId6));
                                            ...
                                            return [
                                              createVNode(_component_ol_style_fill, { color: $data.fillColor }, null, 8, ["color"]),
                                      ...
                                      return [
                                        createVNode(_component_ol_style_circle, { radius: $data.radius }, {
                                          default: withCtx(() => [
                                            createVNode(_component_ol_style_fill, { color: $data.fillColor }, null, 8, ["color"]),
                                            createVNode(_component_ol_style_stroke, {
                                              color: $data.strokeColor,
                                ...
                                return [
                                  createVNode(_component_ol_geom_point, { coordinates: $data.coordinates }, null, 8, ["coordinates"]),
    ...
    _push(`<div class="mt-16"><h2 class="text-3xl font-semibold mt-32 mb-12">Similar Properties</h2><div class="grid grid-cols-1 md:grid-cols-3 gap-4"><!--[-->`);
...
const __listingName_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { __listingName_ as default };
//# sourceMappingURL=_listingName_-mz0aKb_z.mjs.map
