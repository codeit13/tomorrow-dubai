...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div></div></div></div></div><div class="px-6 py-24 md:px-28 md:pb-40 md:pt-38"><div class="flex justify-between items-baseline mb-12"><h2 class="text-2xl md:text-4xl font-extrabold josefin-slab"> Neighborhood For You </h2><span class="text-sm md:text-lg font-semibold cursor-pointer">More &gt;</span></div><div class="grid grid-cols-1 md:grid-cols-3 gap-4"><!--[-->`);
...
//# sourceMappingURL=index-er47Xdze.mjs.map
