import { useSSRContext, unref, mergeProps, withCtx, renderSlot, computed, createVNode } from 'vue';
import { ssrRenderComponent, ssrRenderSlot } from 'vue/server-renderer';
import { useForwardPropsEmits, SelectRoot, SelectValue, useForwardProps, SelectTrigger, SelectIcon, SelectPortal, SelectContent, SelectViewport, SelectItem, SelectItemIndicator, SelectItemText, SelectScrollUpButton as SelectScrollUpButton$1, SelectScrollDownButton as SelectScrollDownButton$1 } from 'radix-vue';
import { CaretSortIcon, CheckIcon, ChevronUpIcon, ChevronDownIcon } from '@radix-icons/vue';
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(SelectIcon), { "as-child": "" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(CaretSortIcon), { class: "w-4 h-4 opacity-50" }, null, _parent3, _scopeId2));
                } else {
                  return [
                    createVNode(unref(CaretSortIcon), { class: "w-4 h-4 opacity-50" })
                  ];
                }
              }),
              _: 1
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const forwardedProps = useForwardProps(delegatedProps);
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(SelectScrollUpButton$1), mergeProps(unref(forwardedProps), {
...
const SelectScrollUpButton = _sfc_main$1;
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const forwardedProps = useForwardProps(delegatedProps);
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(SelectScrollDownButton$1), mergeProps(unref(forwardedProps), {
        class: unref(cn)("flex cursor-default items-center justify-center py-1", props.class)
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
const SelectScrollDownButton = _sfc_main;

export { __nuxt_component_3 as _, __nuxt_component_2 as a, __nuxt_component_5 as b, __nuxt_component_4 as c, __nuxt_component_1 as d };
//# sourceMappingURL=SelectScrollDownButton-9flwTiCk.mjs.map
