...
export default {
  ...
  methods: {
    ...
    openPropertyModal(property) {
      ...
      this.propertySize = property.sqFt;
      this.noOfBeds = property.bed;
      this.noOfBaths = property.bath;
      this.propertyPrice = property.price;
      this.propertyDescription = property.description;
      this.isOffPlan = property.isOffPlan ? "YES" : "NO";
      ...
      // this.paymentPlans = Object.keys(property.paymentPlans).map((key) => {
      //   return {
      //     name: key,
      //     value: property.paymentPlans[key],
      //   };
      // });
