      ...
      >
        ...
        <div>
          ...
          <ul class="mb-6 flex flex-col gap-1.5">
            <!-- Menu Item Dashboard -->
            <li v-for="(tab, i) in tabItems" :key="i" @click="selectTab(tab)">
              <a
                ...
                "
                :class="{
                  'bg-graydark dark:bg-meta-4': $route.path == tab.route,
                }"
              >
                <svg
                  v-if="tab.name.toLowerCase().includes('dashboard')"
                  class="fill-current"
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
                ...
                <svg
                  v-else-if="tab.name.toLowerCase().includes('listings')"
                  class="fill-current"
                  width="18"
                  height="19"
                  viewBox="0 0 18 19"
                ...
                <svg
                  v-else-if="tab.name.toLowerCase().includes('properties')"
                  class="fill-current"
                  width="18"
                  height="19"
                  viewBox="0 0 18 19"
                ...
                <svg
                  v-else-if="tab.name.toLowerCase().includes('news')"
                  class="fill-current"
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
                ...
                <svg
                  v-else-if="tab.name.toLowerCase().includes('subscribers')"
                  xmlns="http://www.w3.org/2000/svg"
                  height="24"
                  viewBox="0 -960 960 960"
                  width="24"
...
export default {
  ...
  mounted() {
    this.selectedTab = this.tabItems[0].name;
  },
  methods: {
    selectTab(tab) {
